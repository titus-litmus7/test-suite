...
set JAVA_OPTIONS=%JAVA_OPTIONS% -Dlog4j.configuration="file:%XLT_CONFIG_DIR%\scriptdocgenerator.properties"
...
:: run Java
java %JAVA_OPTIONS% com.xceptance.xlt.engine.scripting.docgen.Main %*
