...
JAVA_OPTIONS="$JAVA_OPTIONS -Dlog4j.configuration=\"file:$XLT_CONFIG_DIR/scriptdocgenerator.properties\""
...
# run Java
CMD="java $JAVA_OPTIONS com.xceptance.xlt.engine.scripting.docgen.Main"
ARGS=""
I=1
while [ $I -le $# ]; do
    eval x=\${$I}
